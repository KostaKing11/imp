...
const CACHE_VERSION = "20260803-111042";
...
self.addEventListener("fetch", (event) => {
  ...
  // The page itself: try the network first so a new deploy is picked up,
  ...
  // Everything else (hashed bundles, images, fonts): cache first.
  event.respondWith(
