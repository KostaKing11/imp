...
const en = {
  ...
  skalaClueHint: "Name ONE thing that belongs exactly on the marked spot. Say only the thing — never where it is.",
  skalaHowGiver: "The green bands are the points. The nearer they guess to your spot, the more everybody scores — so aim for a clue that lands them right on it.",
  skalaHowGuesser: "They know a secret spot on this scale and named something that sits there. Turn the dial to where you think that thing belongs.",
  ...
  skalaGuessTitle: "Where did they mean?",
  skalaSaid: "{name} said",
  ...
  skalaRoundsStepper: "Rounds in the game",
  ...
  tourSingleGame: "One game",
  tourMode: "Tournament",
  tourSelectedOf: "{done} of {total} on",
  tourTargetHint: "Tap to change",
  tourTargetRange: "Anything from 1 to 99.",
  tourNoModes: "Turn at least one mode on.",
  ...
  syncSeedInstr: "Everyone taps their own name and writes one association to the word.",
  syncBetweenInstr: "Everyone taps their own name and writes a word that sits between the last ones.",
  syncBetweenLabel: "Find the word between",
  syncTapToWrite: "tap to write",
  ...
  onePhone: "Local",
  localMultiplayer: "Online",
  onePhoneWhat: "One phone, passed around the circle.",
  localMultiplayerWhat: "Everyone on their own phone, wherever they are.",
  // local multiplayer
  yourName: "Your name",
  hostGame: "HOST",
  joinGame: "JOIN",
  ...
  hostDecidesLanguage: "The host picks the language for everyone in the room.",
...
const sr: typeof en = {
  ...
  skalaClueHint: "Reci JEDNU stvar koja tačno tu stoji. Kaži samo tu stvar — nikad gde je.",
  skalaHowGiver: "Zelena polja su poeni. Što bliže tvojoj tački pogode, to svi više osvajaju — zato smisli trag koji ih dovede baš na nju.",
  skalaHowGuesser: "On zna tajnu tačku na ovoj skali i rekao je nešto što tu stoji. Okreni strelicu tamo gde misliš da ta stvar pripada.",
  ...
  skalaRoundsStepper: "Rundi u partiji",
  ...
  tourSingleGame: "Jedna partija",
  tourMode: "Turnir",
  tourSelectedOf: "{done} od {total}",
  tourTargetHint: "Dodirni da promeniš",
  tourTargetRange: "Bilo šta od 1 do 99.",
  tourNoModes: "Uključi bar jedan mod.",
  ...
  syncSeedInstr: "Svako dodirne svoje ime i napiše jednu asocijaciju na reč.",
  syncBetweenInstr: "Svako dodirne svoje ime i napiše reč koja stoji između prethodnih.",
  syncBetweenLabel: "Nađi reč između",
  syncTapToWrite: "dodirni da napišeš",
  ...
  onePhone: "Local",
  localMultiplayer: "Online",
  onePhoneWhat: "Jedan telefon, dodaje se ukrug.",
  localMultiplayerWhat: "Svako na svom telefonu, gde god da je.",
  // local multiplayer
  yourName: "Tvoje ime",
  hostGame: "NAPRAVI",
  ...
  hostDecidesLanguage: "Domaćin bira jezik za sve u sobi.",
