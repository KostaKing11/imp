...
const en = {
  ...
  close: "Close",
  sameWifiHint: "Everyone on the same Wi-Fi, no internet — installed app only.",
  netWebOnly:
    "This needs the installed app — a browser can't open a room without internet.",
  netModeOnline: "Internet",
  netModeLan: "No internet",
  onlineHint: "Android and iPhone together — you can even play from home.",
...
const sr: typeof en = {
  ...
  close: "Zatvori",
  sameWifiHint: "Svi na istom Wi-Fi-ju, bez interneta — samo instalirana aplikacija.",
  netWebOnly:
    "Za ovo treba instalirana aplikacija — browser ne može da otvori sobu bez interneta.",
  netModeOnline: "Internet",
  netModeLan: "Bez interneta",
  onlineHint: "Android i iPhone zajedno — može i svako od svoje kuće.",
