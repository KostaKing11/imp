...
const en = {
  ...
  syncSeedInstr: "Everyone taps THEIR OWN card, reads the word in secret and writes one association.",
  syncBetweenInstr: "Everyone taps THEIR OWN card and writes a word that sits between the last ones.",
...
const sr: typeof en = {
  ...
  syncSeedInstr: "Svako dodirne SVOJU karticu, tajno pročita reč i napiše jednu asocijaciju.",
  syncBetweenInstr: "Svako dodirne SVOJU karticu i napiše reč koja stoji između prethodnih.",
