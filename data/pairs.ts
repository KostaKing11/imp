...
export const PAIR_CATEGORIES: PairCategory[] = [
  {
    ...
    pairs: [
      ...
      { main: "Sandwich", odd: "Wrap" },
      { main: "Donut", odd: "Bagel" },
      { main: "Salad", odd: "Coleslaw" },
      { main: "Steak", odd: "Roast" },
      { main: "Sushi", odd: "Sashimi" },
      { main: "Cake", odd: "Pie" },
      { main: "Salt", odd: "Sugar" },
    ],
  },
  {
    ...
    pairs: [
      ...
      { main: "Whale", odd: "Manatee" },
      { main: "Bat", odd: "Owl" },
      { main: "Squirrel", odd: "Chipmunk" },
      { main: "Turtle", odd: "Tortoise" },
      { main: "Spider", odd: "Scorpion" },
      { main: "Deer", odd: "Elk" },
    ],
  },
  {
    ...
    pairs: [
      ...
      { main: "Lake", odd: "Pond" },
      { main: "Library", odd: "Bookshop" },
      { main: "Museum", odd: "Gallery" },
      { main: "Church", odd: "Temple" },
      { main: "Bakery", odd: "Butcher" },
      { main: "Zoo", odd: "Aquarium" },
      { main: "Farm", odd: "Ranch" },
      { main: "Harbour", odd: "Marina" },
    ],
  },
  {
    name: "Everyday",
    pairs: [
      ...
      { main: "Scarf", odd: "Tie" },
      { main: "Fork", odd: "Spoon" },
      { main: "Soap", odd: "Shampoo" },
      { main: "Wallet", odd: "Purse" },
      { main: "Key", odd: "Card" },
      { main: "Napkin", odd: "Tissue" },
      { main: "Bottle", odd: "Jar" },
      { main: "Hat", odd: "Cap" },
    ],
  },
  {
    ...
    pairs: [
      ...
      { main: "Golf", odd: "Cricket" },
      { main: "Cards", odd: "Dominoes" },
      { main: "Darts", odd: "Bowling" },
      { main: "Surfing", odd: "Sailing" },
      { main: "Karate", odd: "Judo" },
      { main: "Cycling", odd: "Skating" },
    ],
  },
  {
    name: "Travel",
    pairs: [
      ...
      { main: "Layover", odd: "Delay" },
      { main: "Hostel", odd: "Motel" },
      { main: "Backpacking", odd: "Camping" },
      { main: "Sunscreen", odd: "Insect spray" },
      { main: "Guidebook", odd: "Brochure" },
      { main: "Airport", odd: "Harbour" },
    ],
  },
  {
    name: "Home & Tech",
    pairs: [
      ...
      { main: "Sink", odd: "Basin" },
      { main: "Curtain", odd: "Blind" },
      { main: "Carpet", odd: "Rug" },
      { main: "Lamp", odd: "Chandelier" },
      { main: "Mug", odd: "Glass" },
      { main: "Doorbell", odd: "Alarm" },
    ],
  },
  {
    name: "School & Work",
    pairs: [
      ...
      { main: "Lecture", odd: "Seminar" },
      { main: "Folder", odd: "Envelope" },
      { main: "Chalkboard", odd: "Whiteboard" },
      { main: "Intern", odd: "Trainee" },
      { main: "Resume", odd: "Portfolio" },
      { main: "Test", odd: "Quiz" },
    ],
  },
  {
    ...
    pairs: [
      ...
      { main: "Hail", odd: "Sleet" },
      { main: "Dawn", odd: "Dusk" },
      { main: "Cave", odd: "Canyon" },
      { main: "Leaf", odd: "Petal" },
      { main: "Lightning", odd: "Thunder" },
      { main: "Tide", odd: "Current" },
    ],
  },
  {
    name: "Movies & Music",
    pairs: [
      ...
      { main: "Director", odd: "Producer" },
      { main: "Subtitles", odd: "Dubbing" },
      { main: "Sequel", odd: "Remake" },
      { main: "Choir", odd: "Band" },
      { main: "Radio", odd: "Podcast" },
      { main: "Ballet", odd: "Opera" },
      { main: "Script", odd: "Lyrics" },
    ],
  },
];
